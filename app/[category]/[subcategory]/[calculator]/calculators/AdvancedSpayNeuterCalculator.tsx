    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="bg-background border rounded-xl p-6 sm:p-8 shadow-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button
            ...
            className="sm:w-auto px-6 py-3 border border-input rounded-lg hover:bg-accent transition-colors flex items-center justify-center gap-2"
          >
      ...
      <div className="bg-background border rounded-xl p-6 sm:p-8 mb-6">
        <p className="text-lg text-muted-foreground leading-relaxed">
          Calculate spay and neuter surgery costs for dogs, cats, and rabbits with the most comprehensive cost estimator available.
          Compare clinic types, regional pricing, traditional vs laparoscopic procedures, and get personalized recommendations based
          on your pet&apos;s age, size, breed, and location. Our calculator considers 15+ cost factors including special conditions,
          additional services, insurance reimbursements, and multi-pet discounts to provide the most accurate cost estimate possible.
          Make informed decisions about your pet&apos;s surgical care with detailed breakdowns, money-saving tips, and evidence-based
